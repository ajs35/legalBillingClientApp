...
import { IconBack, IconSend, IconSparkleWhite } from '../components/Icons';
...
export function AskEllyView() {
  ...
  return (
    <section className="view active">
      ...
      <div className="scroll col" ref={threadRef} style={{ paddingTop: 6, paddingLeft: 20, paddingRight: 20, paddingBottom: 196, gap: 14 }}>
        {thread.map((m) => (
